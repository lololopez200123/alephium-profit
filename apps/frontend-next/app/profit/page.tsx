  ...
  return (
    ...
    >
      ...
      <Box sx={{ paddingTop: '2rem', height: '350px' }}>
        <Typography sx={{ fontSize: '0.9375rem' }}>{selectCoin?.name}</Typography>
        <Box
          sx={{
            display: 'flex',
        ...
        >
          <Typography sx={{ fontSize: '2.5rem' }}>{selectCoin?.cant}</Typography>
          <Typography
            sx={{
              fontSize: '0.9375rem',
              paddingLeft: '1%',
      ...
      {/*Favorite Coins */}
      <Typography sx={{ marginBottom: '5px', marginLeft: '20px' }} fontSize="0.625rem" variant="caption">
        MY GRAPHS
      </Typography>
      <Box sx={{}}>
        <Box sx={{ height: '100%' }}>
          {coin?.map((item, index) => (
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                ...
                >
                  <Image width="16" height="16" alt={item.name} src="/ALPHAGA.png" />
                </Box>
