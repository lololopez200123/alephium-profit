...
async function Home() {
  ...
  const coinData = coinResponse.map((coin) => {
    return {
      ...
      price:
        coin.price >= 1000
          ? parseFloat(coin.price.toFixed(0))
          : parseFloat(coin.price.toFixed(2)),
      amount:
        coin.amount >= 1000
          ? parseFloat(coin.amount.toFixed(0))
  ...
  return (
    ...
    >
          ...
          >
            ...
            <p>
              <span
                style={{
                  backgroundImage:
                    "linear-gradient(147.7deg, #6942E2 19.37%, #28E7C5 77.65%)",
                  backgroundClip: "text",
                  color: "transparent",
                }}
              >
      ...
      <Typography
        sx={{ marginBottom: "0.3125rem", paddingInline: "1.25rem " }}
        fontSize="0.625rem"
        variant="caption"
      >
        COINS
